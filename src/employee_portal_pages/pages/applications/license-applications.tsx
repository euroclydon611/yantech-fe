...
import TransferLicenseApplicationModal from "@/employee_portal_pages/components/application/transfer-license-application-modal";
...
const LicenseApplications = () => {
  ...
  const [licenseType, setPermitType] = useState("all");
      ...
      },
      {
        title: (
          ...
          >
            ...
            <SortIndicator field="licenseType" />
          </div>
        ),
        ...
        width: 180,
        sorter: true,
        sortOrder: sortField === "licenseType" ? (sortOrder === "asc" ? "ascend" : "descend") : null,
        render: (licenseType) => (
  ...
  return (
    <>
      ...
      {transferModalOpen && (
        <TransferLicenseApplicationModal
      ...
      <StatisticsModal
        ...
        title="License Application Statistics"
      />
      ...
      <div className="license-app-page-root flex flex-col">
        ...
        <div className="px-4 pt-3 pb-1 border-b border-gray-100 bg-white">
          <Breadcrumb
            items={[
              ...
              { title: "Licensing MGT" },
              { title: <span className="text-green-700 font-medium">License Applications</span> },
            ]}
            className="text-xs"
          />
        </div>
        ...
        <div className="px-4 py-2 bg-white border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-sm font-semibold text-gray-800 leading-tight truncate">License Applications</h1>
              <p className="text-[11px] text-gray-500 leading-tight">
                {(employee as any)?.entity?.name || "All Entities"} &mdash; Manage &amp; review license applications
              </p>
            </div>
          </div>
        ...
        <div className="px-4 py-2 bg-gray-50 border-b border-gray-200">
          <Row gutter={[8, 8]} align="middle">
            ...
            <Col xs={12} sm={6} md={5} lg={4} xl={4}>
              <Select value={licenseType} onChange={(v) => handleFilterChange("licenseType", v)} className="w-full" size="small" placeholder="License Type" options={filterOptions.permitTypeOptions} />
            </Col>
            <Col xs={24} sm={14} md={8} lg={6} xl={6}>
              {currentView === "transferred" ? (
                <RangePicker size="small" className="w-full" value={dateRange} onChange={handleRangeChange} placeholder={["Transfer from", "Transfer to"]} />
              ) : (
          ...
          {activeFiltersCount > 0 && (
            <div className="flex flex-wrap gap-1 mt-1.5">
              ...
              {licenseType !== "all" && <Tag closable onClose={() => handleFilterChange("licenseType", "all")} color="purple" className="text-[10px] leading-tight m-0">Type: {licenseType.replace(/_/g, " ")}</Tag>}
        ...
        <div className="px-4 py-2 border-t border-gray-200 bg-white flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          {paginationInfo && paginationInfo.total > 0 && (
            <Pagination current={page} pageSize={limit} total={paginationInfo.total}
              ...
              showSizeChanger showQuickJumper size="small" className="license-app-pagination" />
          )}
        </div>
      </div>
      <style>{`
        .license-app-page-root { min-height: calc(100vh - 48px); display: flex; flex-direction: column; }
        .license-app-table .ant-table-thead > tr > th { background: #f1f5f9; font-weight: 600; font-size: 11px; color: #374151; border-bottom: 2px solid #e2e8f0; white-space: nowrap; }
        .license-app-table .ant-table-tbody > tr > td { border-bottom: 1px solid #f1f5f9; font-size: 11px; }
        .license-app-table .ant-table-tbody > tr:hover > td { background-color: #f0fdf4 !important; }
        .license-app-table .ant-table-body { overflow-y: auto !important; }
        .license-app-table .ant-table-cell-fix-right { background: #fff; }
        .license-app-table tr.bg-gray-50\/60 .ant-table-cell-fix-right { background: #f9fafb; }
        .license-app-table .ant-table-thead .ant-table-cell-fix-right { background: #f1f5f9 !important; }
        .license-app-pagination .ant-pagination-item-active { border-color: #15803d; background-color: #15803d; }
        .license-app-pagination .ant-pagination-item-active a { color: #fff; }
        .license-app-pagination .ant-pagination-item-active:hover { border-color: #166534; background-color: #166534; }
      `}</style>
    </>
  );
};
