...
interface IssueHazardousWasteDisposalPermitProps {
  applicationData: any;
  task?: any;
...
const IssueHazardousWasteDisposalPermit: React.FC<
  IssueHazardousWasteDisposalPermitProps
> = ({ applicationData, task, isSubmitting, onSubmit, onSave }) => {
  ...
  const buildPayload = async () => {
    ...
    const data = {
      ...
      permitType: values.permitType || "hazardous_waste_disposal",
      ...
      <div className="flex-1 flex flex-col bg-white border border-slate-200 rounded-lg overflow-hidden">
        <div className="p-4 border-b border-slate-200 flex-shrink-0">
          <h3 className="font-bold text-slate-800">
            Hazardous Waste Disposal Permit Details
          </h3>
        </div>
...
export default IssueHazardousWasteDisposalPermit;
