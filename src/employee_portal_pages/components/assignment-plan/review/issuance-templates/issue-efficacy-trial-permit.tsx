...
interface IssueEfficacyTrialPermitProps {
  applicationData: any;
  task?: any;
...
const IssueEfficacyTrialPermit: React.FC<IssueEfficacyTrialPermitProps> = ({
  applicationData,
  task,
  isSubmitting,
  onSubmit,
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      permitType: permitData?.permitType || "efficacy_trial",
  ...
  const buildPayload = async () => {
    ...
    const data = {
      permitApplicationId: applicationData?.applicationId?._id,
      permitId: issuedPermit?.data?._id,
      applicationId: applicationData?.applicationId?._id,
      productId: applicationData?.productId,
      clientId: applicationData?.clientId?._id,
      permitType: values.permitType || "efficacy_trial",
...
export default IssueEfficacyTrialPermit;
