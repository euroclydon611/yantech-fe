...
interface IssueDomesticPurchasePermitProps {
  applicationData: any;
  task?: any;
...
const IssueDomesticPurchasePermit: React.FC<
  IssueDomesticPurchasePermitProps
> = ({ applicationData, task, isSubmitting, onSubmit, onSave }) => {
  ...
  const buildPayload = async () => {
    ...
    const data = {
      ...
      permitType: values.permitType || "domestic_purchase",
      ...
      <div className="flex-1 flex flex-col bg-white border border-slate-200 rounded-lg overflow-hidden">
        <div className="p-4 border-b border-slate-200 flex-shrink-0">
          <h3 className="font-bold text-slate-800">
            Domestic Purchase of Industrial and Consumer Chemical(s) Details
          </h3>
        </div>
...
export default IssueDomesticPurchasePermit;
