...
const PesticideTransportationReview: React.FC<TransportationReviewProps> = ({
  application,
  onApplicationUpdate,
}) => {
  const {
  ...
  return (
    <div className={styles.reviewPage}>
      <h2 className={styles.mainTitle}>
        Transportation License Application Review
      </h2>
...
export default PesticideTransportationReview;
