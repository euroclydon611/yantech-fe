...
interface TransferAuthorizationRequestModalProps {
  isOpen: boolean;
  onClose: () => void;
  application: any;
  refreshData?: () => void;
...
const TransferAuthorizationRequestModal: React.FC<
  TransferAuthorizationRequestModalProps
    ...
    if (result.isConfirmed) {
      try {
        ...
        await Swal.fire({
          ...
          text:
            response.message ||
            "The authorization request has been transferred successfully.",
          icon: "success",
          confirmButtonColor: "#2E7D32",
        });
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="space-y-2">
            <div className="flex justify-between items-start">
              ...
              <div>
                <p className="text-sm text-gray-600">Authorization Type</p>
                <p className="font-semibold text-gray-800">
                  {normalizeText(application?.authorizationType) || "N/A"}
                </p>
              </div>
            </div>
            <div>
        ...
        <div>
          ...
          <Input.TextArea
            placeholder="Provide a reason for transferring this authorization request..."
            rows={4}
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
          <p className="text-xs text-amber-800">
            ...
            the authorization request, assignment plan, and all associated
...
export default TransferAuthorizationRequestModal;
