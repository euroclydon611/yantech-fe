...
export const EnvironmentalRenewableAndNonRenewableEnergyPreview: React.FC<
...
> = ({ application }) => {
  ...
  const getCategoryLabel = (category: string) => {
    ...
    return categories[category] || normalizeText(category) || "N/A";
  };
      ...
      <div className={styles.gridContainer}>
        ...
        <Block title="2. Permit Information">
          ...
          <Detail
            ...
            value={`ENERGY SECTOR - ${getCategoryLabel(energyCategory)}`}
          />
          <Detail
            label={`Energy Type:`}
            value={normalizeText(energySubType?.toUpperCase())}
          />
        </Block>
        ...
        >
          ...
          <div className="mb-4 mt-4">
            ...
            {infrastructure?.water?.sources &&
              infrastructure.water.sources.length > 0 && (
                <div className="mb-4">
                  <Title
                    level={5}
                  ...
                  <Detail
                    ...
                    value={infrastructure.water.sources.join(", ") || "N/A"}
                  />
                </div>
              )}
            ...
            {infrastructure?.water?.otherSources && (
              <div className="mb-4">
                <Detail
                  label="Other Sources:"
                  value={infrastructure.water.otherSources || "N/A"}
                />
              </div>
            )}
        ...
        <Block title="6. Stakeholder Consultation" className={styles.fullWidth}>
        ...
        {permitDetails?.applicationType === "renewal" && (
          <Block
            ...
            className={styles.fullWidth}
          >
            {energyData?.previousPermit ? (
              <div className="space-y-4">
                <Detail
                  label="Permit Number:"
                  value={energyData.previousPermit.permitNumber || "N/A"}
                />
                <Detail
                  label="Issue Date:"
                  value={
                    energyData.previousPermit.permitIssuedDate
                      ? formatDate(energyData.previousPermit.permitIssuedDate)
                      : "N/A"
                  }
                />
                <Detail
                  label="Expiry Date:"
                  value={
                    energyData.previousPermit.permitExpiryDate
                      ? formatDate(energyData.previousPermit.permitExpiryDate)
                      : "N/A"
                  }
                />
                {energyData.previousPermit.permitDocument && (
                  <div className="mt-4">
...
export default EnvironmentalRenewableAndNonRenewableEnergyPreview;
