...
export const EnvironmentalOtherPetroleumPreview: React.FC<
      ...
      <div className={styles.gridContainer}>
        ...
        {permitDetails?.applicationType === "renewal" && (
          <Block
            ...
            className={styles.fullWidth}
          >
            {activityData?.previousPermit ? (
              <div className="space-y-4">
                <Detail
                  label="Permit Number:"
                  value={activityData.previousPermit.permitNumber || "N/A"}
                />
                <Detail
                  label="Issue Date:"
                  value={
                    activityData.previousPermit.permitIssuedDate
                      ? formatDate(activityData.previousPermit.permitIssuedDate)
                      : "N/A"
                  }
                />
                <Detail
                  label="Expiry Date:"
                  value={
                    activityData.previousPermit.permitExpiryDate
                      ? formatDate(activityData.previousPermit.permitExpiryDate)
                      : "N/A"
                  }
                />
                {activityData.previousPermit.permitDocument && (
                  <div className="mt-4">
...
export default EnvironmentalOtherPetroleumPreview;
