...
export const WasteManagementEnvironmentalPreview: React.FC<
...
> = ({ application }) => {
  ...
  const wasteManagementData =
    answers?.environmentalPermitData?.wasteManagement || {};
  const {
    projectOverview,
    siteDetails,
    infrastructure,
  ...
  const formatFacilityType = (facilityBase: string) => {
    ...
    return facilityMap[facilityBase] || facilityBase;
  };
    ...
    <div className={styles.reviewPage}>
      ...
      <div className={styles.gridContainer}>
        ...
        <Block title="2. Permit Information">
          ...
          <Detail label="Permit Category:" value="WASTE MANAGEMENT" />
        </Block>

        {/* --- BLOCK 3: Project Overview --- */}
        <Block title="3. Project Overview" className={styles.fullWidth}>
          <Detail label="Operation Name:" value={projectOverview?.title} />
          <Detail
            label="Operation Description:"
            value={projectOverview?.description}
          />
          <Detail
            label="Operational Scope & Key Activities:"
            value={projectOverview?.scope}
          />
          <Detail
            label="Operation Type:"
            value={
              projectOverview?.operationType === "facility"
                ? "Facility-Based"
                : projectOverview?.operationType === "service"
                ? "Service-Based"
                : "-"
            }
          />
          ...
          {projectOverview?.operationType === "facility" && (
            <>
              <Detail
                label="Facility Type:"
                value={formatFacilityType(projectOverview?.facilityBase)}
              />
              {projectOverview?.facilityBase === "other" && (
                <Detail
                  label="Specify Facility Type:"
                  value={projectOverview?.facilityBaseOther}
                />
              )}
            </>
          )}
          ...
          {projectOverview?.operationType === "service" && (
            <Detail
              ...
              value={projectOverview?.servicesCoverageArea}
            />
          )}
        </Block>
        ...
        <Block title="4. Site Details" className={styles.fullWidth}>
          ...
          {/* Adjacent Land Uses - Only for Facility-Based */}
          {projectOverview?.operationType === "facility" &&
          ...
          />
          {/* Proximity Conditions - Only for Facility-Based */}
          {projectOverview?.operationType === "facility" && (
            <>
              {/* Near Water Body */}
              <div className="mt-3">
                    ...
                    siteDetails?.nearWaterBody?.isNear ? (
                      <span>
                        ...
                        {siteDetails.nearWaterBody.distance && (
                          <span className="ml-2">
                            Distance: {siteDetails.nearWaterBody.distance}{" "}
                            metres
                          </span>
                        )}
                      </span>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex items-center space-x-2 mt-1 text-red-600">
                      ...
                      <span>
                        ...
                        attached — refer to{" "}
                        <strong>Block 7 (Supporting Documents)</strong>
                      </span>
                    </div>
                  </div>
                )}{" "}
                    ...
                    <div className="mb-3">
                      ...
                      {compliance?.companyPolicies.ohs.policyDoc && (
                        <div className="flex items-center space-x-2 mt-1">
                          <Text className="text-red-600">
                            Policy Document{" "}
                            {compliance?.companyPolicies.ohs?.policyDoc?.name ||
                              "Attachment"}{" "}
                            attached — refer to{" "}
                            <strong>Block 7 (Supporting Documents)</strong>
                          </Text>
...
export default WasteManagementEnvironmentalPreview;
