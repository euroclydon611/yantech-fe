...
interface EnvironmentalMediumScaleMiningReviewProps {
  application: any;
}

export const EnvironmentalMediumScaleMiningPreview: React.FC<
  EnvironmentalMediumScaleMiningReviewProps
> = ({ application }) => {
  const { answers } = application;

  const { permitDetails } = answers || {};
  const miningData = answers?.environmentalPermitData?.mining || {};
  const mediumScaleData = miningData?.mediumScale || {};
      ...
      <div className={styles.gridContainer}>
        ...
        <Block title="2. Permit Information">
          ...
          <Detail
            ...
            value="MINING SECTOR - MEDIUM SCALE OPERATIONS"
          />
        </Block>
        ...
        {/* --- BLOCK 5: Infrastructure & Utilities - Hide for Renewals --- */}
        {permitDetails?.applicationType !== "renewal" && (
          <Block
        ...
        {/* --- BLOCK 6: Environmental Impacts & Mitigation - Hide for Renewals --- */}
        {permitDetails?.applicationType !== "renewal" && (
          <Block
        ...
        {/* --- BLOCK 7: Stakeholder Consultation - Hide for Renewals --- */}
        {permitDetails?.applicationType !== "renewal" && (
          <Block
          ...
          >
            {impactsMitigation?.stakeholderConsultation
              ?.consultationConducted !== undefined && (
              <Detail
        ...
        {permitDetails?.applicationType === "renewal" && (
          <>
            <Block
              ...
              className={styles.fullWidth}
            >
              {mediumScaleData?.previousPermit ? (
                <div className="space-y-4">
                  <Detail
                    label="Permit Number:"
                    value={mediumScaleData.previousPermit.permitNumber || "N/A"}
                  />
                  <Detail
                    label="Issue Date:"
                    value={
                      mediumScaleData.previousPermit.permitIssuedDate
                        ? formatDate(
                            mediumScaleData.previousPermit.permitIssuedDate
                          )
                        : "N/A"
                  ...
                  <Detail
                    label="Expiry Date:"
                    value={
                      mediumScaleData.previousPermit.permitExpiryDate
                        ? formatDate(
                            mediumScaleData.previousPermit.permitExpiryDate
                          )
                        : "N/A"
                  ...
                  />
                  {mediumScaleData.previousPermit.permitDocument && (
                    <div className="mt-4">
...
export default EnvironmentalMediumScaleMiningPreview;
