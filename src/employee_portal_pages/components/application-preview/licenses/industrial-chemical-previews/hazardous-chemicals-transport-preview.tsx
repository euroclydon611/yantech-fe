...
const HazardousChemicalsTransportationPreview: React.FC<HazardousChemicalsTransportationReviewProps> = ({
  application,
}) => {
  const {
    applicationType,
    ...
    <div className={styles.reviewPage}>
      ...
      <div className={styles.gridContainer}>
        ...
        <Block title="2. Application Summary">
          ...
          <Detail
            label="Category"
            value={normalizeText(licenseCategory).concat(" (Hazardous Chemicals Transport)") || "—"}
          />
          <Detail
...
export default HazardousChemicalsTransportationPreview;
