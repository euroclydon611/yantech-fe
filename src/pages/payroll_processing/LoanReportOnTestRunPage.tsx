...
const LoanReportOnTestRunPage = ({ currency, year, payMonth }) => {
  ...
  const { data: loanReportData, isLoading: reportLoading } = useLoanReportQuery(
    {
      page,
      limit,
      searchTerm,
        ...
        <div className="flex justify-between w-full p-4">
          ...
          <div className="flex gap-x-4">
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-loan?forecast=${forecast}&year=${year1}&month=${pay_month}&currency=${currency}`,
                  `Consolidated_Loan_Report_${pay_month}_${year1}_${currency}`
                )
              }
            >
              <MdDownload size={18} />
            ...
            <button
              ...
              onClick={() =>
                exportZipData(
                  `reports/export-loan-zip?forecast=${forecast}&year=${year1}&month=${pay_month}&currency=${currency}`,
                  `Lender_Loan_Reports_${pay_month}_${year1}_${currency}`
                )
              }
            >
              <MdDownload size={18} />
...
export default LoanReportOnTestRunPage;
