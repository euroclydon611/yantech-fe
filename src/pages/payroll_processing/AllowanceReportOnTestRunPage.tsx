...
const AllowanceReportOnTestRunPage = ({ currency, year, payMonth }) => {
      ...
      <div className="mx-2 p-2 bg-white rounded-md mt-4">
        <div className="flex justify-between w-full p-4">
          <h1 className="text-[15px] font-medium">
            Other Earnings Report | {pay_month + " " + year1}
          </h1>
          <div className="flex gap-x-4">
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-allowances?forecast=${forecast}&year=${year1}&month=${pay_month}&currency=${currency}`,
                  `Consolidated_Other_Earnings_Report_${pay_month}_${year1}_${currency}`
                )
              }
            >
              <MdDownload size={18} />
            ...
            <button
              ...
              onClick={() =>
                exportZipData(
                  `reports/export-allowances-zip?forecast=${forecast}&year=${year1}&month=${pay_month}&currency=${currency}`,
                  `Earnings_wise_Other_Earnings_Reports_${pay_month}_${year1}_${currency}`
                )
              }
            >
              <MdDownload size={18} />
              <span className="max-md:hidden flex">Type-wise (ZIP)</span>
            </button>
          </div>
        </div>
        <div>
...
export default AllowanceReportOnTestRunPage;
