...
const SsnitReport1OnTestRunPage = ({currency, year, payMonth}) => {
  ...
  const { data: tier_1_ReportData, isLoading: reportLoading } =
        ...
        <div className="flex justify-between w-full p-4">
          ...
          <div>
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-ssnit-tiers?forecast=${forecast}&year=${year1}&month=${pay_month}&tier=1&currency=${currency}`,
                  `Tier1_report_${pay_month}_${year1}_${currency}`
                )
              }
            >
              <MdDownload size={18} />
...
export default SsnitReport1OnTestRunPage;
