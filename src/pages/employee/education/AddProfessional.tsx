...
const AddProfessional = ({ setOpen, data, refetch }: any) => {
  ...
  const existingProfessions = data?.professional_qualifications;
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      await employeeUpdate({
        ...
        professional_qualifications: [...existingProfessions, values],
      });
    },
