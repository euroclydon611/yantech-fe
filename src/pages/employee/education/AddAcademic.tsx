...
const schema = Yup.object().shape({
  institution: Yup.string().required("School is required"),
  name: Yup.string().required("Qualification is required"),
});

const AddAcademic = ({ setOpen, data, refetch }: any) => {
  // const { refetch } = useLoadEmployeeQuery({});
  ...
  const existingQualifications = data?.academic_qualifications;

  const formik = useFormik({
    initialValues: { name: "", institution: "", start_date: "", end_date: "" },
    ...
    onSubmit: async () => {
      ...
      await employeeUpdate({
        ...
        academic_qualifications: [...existingQualifications, values],
      });
    },
