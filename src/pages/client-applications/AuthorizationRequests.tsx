...
import { useDeleteSubmittedApplicationMutation, useGetAdminAuthorizationRequestsQuery } from "../../redux/features/general/client-applications";
...
const AuthorizationRequests = () => {
  PageTitle("Authorization Requests | EPA Ghana Admin");
  ...
  const handleDelete = async (id: string) => {
    try {
      await deleteApplication({ applicationType: "authorization", id }).unwrap();
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="flex items-start gap-2 py-0.5">
          <div className="flex-shrink-0 w-7 h-7 rounded bg-purple-50 text-purple-600 flex items-center justify-center text-[10px] font-extrabold border border-purple-200 mt-0.5">
            A
          </div>
          <div className="min-w-0 flex-1">
            <Tooltip
              title={record.title || normalizeText(record.authorizationType)}
              placement="topLeft"
            >
              <p className="text-xs font-semibold text-gray-900 leading-tight truncate w-full">
                {record.title ||
                  normalizeText(record.authorizationType) ||
                  "N/A"}
              </p>
            </Tooltip>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select
              ...
              size="middle"
            >
              {authorizationRequestTypes.map((t) => (
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 uppercase tracking-wider">
            Admin-wide view of all authorization requests across entities
          </p>
        </div>
        <button
