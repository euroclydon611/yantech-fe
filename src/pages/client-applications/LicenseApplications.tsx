...
import { useDeleteSubmittedApplicationMutation, useGetAdminLicenseApplicationsQuery } from "../../redux/features/general/client-applications";
...
const LicenseApplications = () => {
  PageTitle("License Applications | EPA Ghana Admin");
  ...
  const handleDelete = async (id: string) => {
    try {
      await deleteApplication({ applicationType: "license", id }).unwrap();
      ...
      render: (_: any, record: any) => (
        <div className="flex items-start gap-2 py-0.5">
          ...
          <div className="min-w-0 flex-1">
            <Tooltip
              title={record.title || normalizeText(record.licenseType)}
              placement="topLeft"
            >
              <p className="text-xs font-semibold text-gray-900 leading-tight truncate w-full">
                {record.title || normalizeText(record.licenseType) || "N/A"}
              </p>
            </Tooltip>
            ...
            <div className="flex gap-2 items-center mt-1 flex-wrap">
              ...
              {record.licenseCategory && (
                <span className="text-[9px] text-gray-500 bg-gray-50 border border-gray-200 px-1 rounded uppercase">
                  {normalizeText(record.licenseCategory)}
                </span>
              )}
              <Tag
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 uppercase tracking-wider">
            Admin-wide view of all license applications across entities
          </p>
        </div>
        <button
