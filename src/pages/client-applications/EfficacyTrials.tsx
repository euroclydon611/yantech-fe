...
import { useDeleteSubmittedApplicationMutation, useGetAdminEfficacyTrialsQuery } from "../../redux/features/general/client-applications";
...
const EfficacyTrials = () => {
  PageTitle("Bio-Efficacy Trials | EPA Ghana Admin");
  ...
  const handleDelete = async (id: string) => {
    try {
      await deleteApplication({ applicationType: "efficacy", id }).unwrap();
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <div className="flex items-start gap-2 py-0.5">
          <div className="flex-shrink-0 w-7 h-7 rounded bg-teal-50 text-teal-600 flex items-center justify-center text-[10px] font-extrabold border border-teal-200 mt-0.5">
            BT
          </div>
          <div className="min-w-0 flex-1">
            ...
            <div className="flex gap-2 items-center mt-1 flex-wrap">
              ...
              {record.applicationCode && (
                <span className="text-[9px] text-gray-400 font-mono bg-gray-50 border border-gray-200 px-1 rounded uppercase">
                  Ref: {record.applicationCode}
                </span>
              )}
              <Tag
    ...
    },
    {
      ...
      width: 130,
      render: (date: any) => (
        <span className="text-xs text-gray-500">{formatDate2(date)}</span>
      ),
    },
    {
      title: "Action",
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 uppercase tracking-wider">
            Admin-wide view of all bio-efficacy trial applications across
            entities
          </p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-4 border-b border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 bg-gray-50/50">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              type="text"
              placeholder="Search by code, product name or reference..."
