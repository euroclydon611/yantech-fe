...
import { useLeaveDecisionMutation } from "../../redux/features/users/leaveApi";
import Swal from "sweetalert2";
import dayjs from "dayjs";
import { Calendar, CheckCircle, Info, User, Clock } from "lucide-react";
...
const EditLeave = ({ open, setOpen, itemData, refetch }: any) => {
  const [leaveDecision, { data, isSuccess, isLoading, error }] =
    useLeaveDecisionMutation();

  const formik = useFormik({
    initialValues: {
      leave_name: itemData?.leave_name as string,
          ...
          <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
            ...
            <div>
              ...
              <Text strong className="text-blue-600">
                {itemData?.remaining_leave_days || 0} Days
              </Text>
            </div>
          </div>
        </section>
