...
import { useTier_2_ReportQuery } from "../../redux/features/reports/ssnitReportApi";
...
const SsnitReport2 = () => {
  PageTitle("Tier 2 Report | Payroll");
  ...
  const { data: tier_2_ReportData, isLoading } = useTier_2_ReportQuery({
    page,
    limit,
    searchTerm,
    sortField,
  ...
  return (
    <>
      <PageLayout
        title="Tier 2 Report"
        breadcrumbs={[{ label: "Payroll" }, { label: "Reports" }, { label: "SSNIT Tier 2" }]}
      />
      <div className="p-4">
        ...
        <div className="flex justify-between items-center w-full p-4 bg-white rounded-md">
          ...
          <div>
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-ssnit-tiers?forecast=${forecast}&year=${year}&month=${month}&tier=2&currency=${selectedCurrencyData.code}`,
                  `Tier2_report_${month}_${year}_${selectedCurrencyData.code}`
                )
              }
            >
              <MdDownload size={18} />
        ...
        <div>
          <div className="bg-white p-4">
            ...
            <div className="table-wrapper bg-white rounded-sm shadow-sm">
              <Table
                sticky
                dataSource={tier_2_ReportData?.data || []}
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    sorter: true,
                    onHeaderCell: () => ({
                      onClick: () => handleSort("ssnit_tier2_number"),
                      style: { cursor: "pointer" },
                    }),
                    onCell: () => ({
                      style: { fontSize: "11px", padding: "4px 8px" },
                  ...
                  {
                    title: "Tier 2",
                    dataIndex: "tier_2_contribution",
                    key: "tier_2_contribution",
                    width: 120,
                    align: "right",
                    sorter: true,
                    onHeaderCell: () => ({
                      onClick: () => handleSort("tier_2_contribution"),
                      style: { cursor: "pointer" },
                    }),
                    render: (val) => formatNumber(val) || "0.00",
                    onCell: () => ({
            ...
            <div className="flex mt-4 justify-end">
              <Pagination
                current={page}
                pageSize={limit}
                total={tier_2_ReportData && tier_2_ReportData.totalCount}
