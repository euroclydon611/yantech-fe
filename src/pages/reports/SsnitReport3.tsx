...
const SsnitReport3 = () => {
  PageTitle("Tier 3 Report | Payroll");
  ...
  const { data: tier_3_ReportData, isLoading } = useTier_3_ReportQuery({
    page,
    limit,
    searchTerm,
    sortField,
    ...
    <>
      <div className="pt-4 px-2">
        <div className="flex justify-between">
          <h1 className="text-[18px] mb-3 font-medium">Tier 3 Report</h1>
        ...
        <div className="flex justify-between items-center w-full p-4 bg-white rounded-md">
          ...
          <div>
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-ssnit-tiers?forecast=${forecast}&year=${year}&month=${month}&tier=3&currency=${selectedCurrencyData.code}`,
                  `Tier3_report_${month}_${year}_${selectedCurrencyData.code}`
                )
              }
            >
              <MdDownload size={18} />
