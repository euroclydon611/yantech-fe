...
const OtherDeductionReport = () => {
  PageTitle("Other Deductions Report | Payroll");
  ...
  const { data: reportData, isLoading } = useOtherDeductionReportQuery({
    page,
    limit,
    searchTerm,
    sortField,
  ...
  return (
    <>
      <PageLayout
        ...
        breadcrumbs={[{ label: "Payroll" }, { label: "Reports" }, { label: "Other Deductions" }]}
      />
      <div className="p-4">
        ...
        <div className="flex justify-between items-center w-full p-4 bg-white rounded-md">
          ...
          <div className="flex gap-x-4">
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-other-deductions?forecast=${forecast}&year=${year}&month=${month}&currency=${
                    selectedCurrencyData?.code || "GHS"
                  }`,
                  `Consolidated_Other_Deductions_Report_${month}_${year}_${
                    selectedCurrencyData?.code || "GHS"
                  }`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                exportZipData(
                  `reports/export-other-deductions-zip?forecast=${forecast}&year=${year}&month=${month}&currency=${
                    selectedCurrencyData?.code || "GHS"
                  }`,
                  `Deduction_wise_Other_Deduction_Reports_${month}_${year}_${
                    selectedCurrencyData?.code || "GHS"
                  }`
                )
              }
