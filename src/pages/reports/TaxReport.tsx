...
const TaxReport = () => {
  ...
  const { data: taxReportData, isLoading } = useTaxReportQuery({
    page,
    limit,
    searchTerm,
    sortField,
  ...
  return (
    <>
      <PageLayout
        title="Tax (PAYE) Report"
        breadcrumbs={[{ label: "Payroll" }, { label: "Reports" }, { label: "Tax (PAYE)" }]}
      />
      <div className="p-4">
        ...
        <div className="flex justify-between items-center w-full p-4 bg-white rounded-md">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-tax?forecast=${forecast}&year=${year}&month=${month}&currency=${selectedCurrencyData.code}`,
                  `Tax_report_${month}_${year}_${selectedCurrencyData.code}`
                )
              }
            >
              <MdDownload size={18} />
            ...
            <button
              ...
              onClick={() =>
                exportData(
                  `reports/export-gra-paye-schedule?forecast=${forecast}&year=${year}&month=${month}`,
                  `GRA_PAYE_Schedule_${month}_${year}`
                )
              }
            >
              <MdDownload size={18} />
